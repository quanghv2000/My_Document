...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'ecommerce';
    'jhipster.registry.password' = 'admin';
    'jhipster.security.authentication.jwt.base64-secret' = 'SECRET_TOKEN';
    ...
    'jhipster.mail.from' = 'ecommerce@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'ecommerce API';
    'jhipster.swagger.description' = 'ecommerce API documentation';
    ...
    'eureka.instance.appname' = 'ecommerce';
    'eureka.instance.instanceId' = 'ecommerce:${random.value}';
